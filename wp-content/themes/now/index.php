...
<?php get_header(); ?>
    ...
    <div id="container">
	    <div class="spinner-container content-loaded" style="display: none;">
	    	<div class="spinner">
	    ...
	    <section id="content-container" class="dark">
	    	...
	    	if(!is_single()): ?>
				...
				<div class="text-center" style="margin-bottom: 40px;">
					<a id="loadMore" href="#" rel="<?php global $paged; echo $paged; ?>" class="button radius">
						<?php _e( '加载更多', 'now' ) ?>
					</a>
				</div>
			...
			<?php elseif(current_user_can('edit_post') && !is_search()): ?>
			
				<div class="wrapped-content" style="margin: 0 0 40px;">
					<h2><?php _e('No posts yet', 'now'); ?></h2>
					<p>
						<?php printf(__('Ready to publish your first post? <a href="%s">Get started here</a>.', 'now'), admin_url( 'post-new.php' )); ?>
					</p>
				</div>
